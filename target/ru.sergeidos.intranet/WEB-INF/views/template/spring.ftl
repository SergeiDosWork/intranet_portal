 ...
 *    or CSS styles or size
 -->
<#macro formInput path attributes="" fieldType="text" value="!@#$%^&*()-REPLACED_WITH_BEAN_VALUE">
    <@bind path/>
    <#if "!@#$%^&*()-REPLACED_WITH_BEAN_VALUE" == value>
        <#local value = stringStatusValue?html/>
    </#if>
    <input type="${fieldType}" id="${status.expression}" name="${status.expression}" value="<#if fieldType!="password">${value}</#if>" ${attributes}<@closeTag/>
</#macro>
 ...
 *    or CSS styles or size
 -->
<#macro formPasswordInput path attributes="" value="!@#$%^&*()-REPLACED_WITH_BEAN_VALUE">
    <@formInput path, attributes, "password", value/>
</#macro>
 ...
 *    or CSS styles or size
 -->
<#macro formHiddenInput path attributes="" value="!@#$%^&*()-REPLACED_WITH_BEAN_VALUE">
    <@formInput path, attributes, "hidden", value/>
</#macro>
...
<#macro formCheckbox path attributes="">
    ...
    <#assign isSelected = status.value?? && (status.value?string=="on" || status.value?string=="true")>
	<input type="hidden" name="_${id}" value="on"/>
	<input type="checkbox" id="${id}" name="${id}"<#if isSelected> checked="checked" value="on"</#if> ${attributes}/>
</#macro>
